...
//		spanner.map(new MapFunction<AdjacencyListGraph<Long>, Integer>() {
//			@Override
//			public Integer map(AdjacencyListGraph<Long> graph) throws Exception {
//				return graph.size();
//			}
//		}).print();
...
//	}
	...
	public static final class IdentityAggregate implements AggregateFunction<Tuple2<Long, Long>, Tuple2<Long, Long>, Tuple2<Long, Long>> {
		@Override
