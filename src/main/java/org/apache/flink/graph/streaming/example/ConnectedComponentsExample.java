...
public class ConnectedComponentsExample implements ProgramDescription {
	...
	public static void main(String[] args) throws Exception {
		...
		cc.flatMap(new FlattenSet()).keyBy(0)
				...
				.aggregate(new IdentityAggregate()).print();

//		cc.map(new MapFunction<DisjointSet<Long>, String>() {
//			@Override
//			public String map(DisjointSet<Long> longDisjointSet) throws Exception {
//				return longDisjointSet.toString();
//			}
//		}).print();
	...
	public static class IdentityAggregate implements AggregateFunction<Tuple2<Long, Long>, Tuple2<Long, Long>, Tuple2<Long, Long>> {
		@Override
		...
		public Tuple2<Long, Long> merge(Tuple2<Long, Long> a, Tuple2<Long, Long> b) {
			return a; // Just return one of the values, assuming they are the same
		}
	}
